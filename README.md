...
| Tab                  | Features                                                                                                  |
|----------------------|-----------------------------------------------------------------------------------------------------------|
| **Overview**         | 4 KPI cards, score distribution, scatter plots with trend lines, feature importance, model comparison (R²), top signals, benchmark table, data-driven insights |
...
| Frontend   | HTML5, CSS3 (Inter font, light executive theme), Vanilla JS, Chart.js 4.4.0 |
...
Expand the sections below to inspect the static charts generated from the trained model and dataset.

<details>
<summary><strong>Key Performance Relationships</strong> — score distributions, scatter plots</summary>
...
<details>
<summary><strong>Model &amp; Feature Analysis</strong> — comparison, importance, predictive signals</summary>
