...
plt.tight_layout()
fig.savefig(f'{OUTPUT_DIR}/exam_score_distribution.png', dpi=150, bbox_inches='tight')
plt.close()
...
ax.invert_yaxis()
plt.tight_layout()
fig.savefig(f'{OUTPUT_DIR}/performance_categories.png', dpi=150, bbox_inches='tight')
plt.close()
...
ax.grid(alpha=0.5)
plt.tight_layout()
fig.savefig(f'{OUTPUT_DIR}/study_hours_vs_score.png', dpi=150, bbox_inches='tight')
plt.close()
...
ax.grid(alpha=0.5)
plt.tight_layout()
fig.savefig(f'{OUTPUT_DIR}/attendance_vs_score.png', dpi=150, bbox_inches='tight')
plt.close()
...
ax.grid(axis='x', alpha=0.5)
plt.tight_layout()
fig.savefig(f'{OUTPUT_DIR}/top_signals.png', dpi=150, bbox_inches='tight')
plt.close()
...
# Numeric feature distributions (boxplot)
...
plt.tight_layout()
fig.savefig(f'{OUTPUT_DIR}/dataset_overview.png', dpi=150, bbox_inches='tight')
plt.close()
